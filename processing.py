...
def token_index(tokens, vocabulary, missing='<unk>'):
    """
    Convert a list of word tokens to their corresponding integer indices based on a vocabulary.
...
def main():
    ...
    # Replace duplicate labels using the product map
    ...
    # Convert tokens to integer indices from the vocabulary
